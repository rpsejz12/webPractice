			...
			<article id="work">
				...
				<form action="control.jsp" method="post" name="form2">
					...
					<table border="1">
						<tr>
							<td>이름</td>
							<td><input type="text" name="mname" required value ="${mem.mname}" readonly></td>
						</tr>
						<tr>
							<td>id</td>
							<td><input type="text" name="mid" required value ="${mem.mid}" readonly></td>
						</tr>
						<tr>
							<td>password</td>
							<td><input type="password" name="mpw" required value ="${mem.mpw}"></td>
						</tr>
						<tr>
							<td colspan='2'><input type="submit" value="정보수정"></td>
							 <td><input	type="button" value="회원탈퇴"onClick="location.href='control.jsp?action=signout'"></td>
						</tr>
					</table>
				</form>
