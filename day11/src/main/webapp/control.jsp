 ...
 */
	...
	ProductVO pvo = productDAO.selectOne(buyVO.getBname(), buyVO.getBnum());
	System.out.println(pvo);
	if (pvo != null) {
		buyVO.setBprice(buyDAO.price(pvo, buyVO));
	...
	ArrayList<BuyVO> clist = (ArrayList<BuyVO>) session.getAttribute("clist");
	for (BuyVO vo : clist) {
		ProductVO pvo = productDAO.selectOne(vo.getBname(), vo.getBnum());
		if (pvo != null) {
			flag = true;
	...
	ArrayList<ProductVO> pdlist = productDAO.searchDBList(request.getParameter("content"),
