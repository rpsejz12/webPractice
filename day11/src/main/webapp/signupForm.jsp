							...
							<ul>
								...
								<li><a href="./categories.html">Categories <span
									...
									<ul class="dropdown">
										...
										<li><a href="./signupForm.jsp">Sign Up</a></li>
					...
					<div class="login__form">
						...
						<form action="control.jsp" method="post" name="form1">
							...
							<div class="input__item">
								<input type="text" name="mname" placeholder="name"> <span
									class="icon_mail"></span>
							</div>
							<div class="input__item">
								<input type="text" name="mid" placeholder="id"> <span
									class="icon_profile"></span>
							</div>
							<div class="input__item">
								<input type="text" name="mpw" placeholder="Password"> <span
									class="icon_lock"></span>
							</div>
							<button type="submit" class="site-btn">Signup Now</button>
						</form>
						<h5>
							Already have an account? <a href="./loginForm.jsp">Log In!</a>
						</h5>
					</div>
				</div>
				<div class="col-lg-6">
