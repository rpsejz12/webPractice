...
public class MessageDAO {
	...
	String rSelectAll = "select * from reply where mid=? and rownum <= ? order by rdate asc";
	/*
	...
	public ArrayList<MessageSet> selectAll(String mid) {
		System.out.println("폐이징 page:"+ mid);
