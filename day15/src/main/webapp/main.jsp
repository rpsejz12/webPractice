				...
				<div class="inner">
					...
					<c:forEach var="v" items="${datas}">
						...
						<ul>
							...
							<li>
							<a href="control.jsp?action=main&msgmid=${m.mid}">댓글 더보기</a> &nbsp;&nbsp;
							<c:if test="${m.mid ne rinsertForm and mem.id ne null}">
							<a href="control.jsp?action=rinsertForm&mid=${m.mid}">댓글 등록</a>
							</c:if>
							<c:if test="${m.mid eq rinsertForm}">
